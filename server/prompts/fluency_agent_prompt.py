...
{{
  "rubric_scores": {{
    "no_filler_words": <score 0-1 where you rank how many filler words were used in comparision to the overall text where 1 is filler words are 10% of the text>,
    "no_run_ons": <score 0-1>,
    "good_wpm": <score 0-1>
  }},
  "what_went_right": "",
  "what_went_wrong": "",
